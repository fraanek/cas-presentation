...
<div id="title">Protected contente</div>
...
<div id="slogan">This content is protected for logged users</div>

</div>

<div id="nav">
<a href="<c:url value="/" />">Home</a>
<a class="selected" href="<c:url value="/protected" />">Protected</a>
